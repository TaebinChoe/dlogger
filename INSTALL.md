...
**eAudit** and **Winseal** are compatible with recent 
Linux distributions. They are based on the
...
be compatible with **eAudit** and **Winseal**. 
Use the latest version of BCC from: https://github.com/iovisor/bcc
